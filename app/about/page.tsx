        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center">
              <div className="w-20 h-20 mx-auto mb-6 flex items-center justify-center bg-[#e8f53c] rounded-full">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-12">
            <div className="flex gap-6">
              <div className="flex-shrink-0 w-20 h-20 bg-[#e8f53c] rounded-full flex items-center justify-center font-bold text-2xl">
                2018
              </div>
              <div>
      ...
      <section className="px-6 md:px-10 py-24 bg-[#0f0f0f] text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              href="/bestsellers"
              className="inline-flex items-center gap-2 bg-[#e8f53c] text-[#0f0f0f] px-8 py-4 rounded-full font-medium text-lg hover:bg-[#d4e022] transition-colors"
            >
              Shop Bestsellers
            </Link>
            <Link
